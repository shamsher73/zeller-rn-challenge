...
describe('<CustomerList />', () => {
    ...
    it('should render a list of users based on the selected role', () => {
        ...
        const { getByText } = render(<CustomerList items={items} selectedValue={selectedValue} />);
    ...
    it('should handle empty list of users gracefully', () => {
        ...
        const { getByText, queryByText } = render(<CustomerList items={items} selectedValue={selectedValue} />);
    ...
    test('snapshot', () => {
        ...
        const selectedValue = UserType.ADMIN;
        const tree = render(<CustomerList items={items} selectedValue={selectedValue} />).toJSON();
